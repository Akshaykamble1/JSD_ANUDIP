class Employee{
    ...
    protected int id;
    //protected int age = 25.5;   // Type mismatch error encounters cannot convert from double to int 
    protected double age= 89.5;  // here we change the datatype from int to double
